...
[![Number of Installs](https://visitly.paodayag.dev/coolstore.zip/badge?label=Installs)](https://visitly.paodayag.dev) [![Number of Unique Installs](https://visitly.paodayag.dev/coolstore.zip/badge?unique=1&label=Unique%20Installs)](https://visitly.paodayag.dev)
